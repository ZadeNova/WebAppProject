...
public class ShoppingCartItem : IEquatable<ShoppingCartItem>
{
    ...
    public ShoppingCartItem(string productID, ZadeProduct prod)
    {
        this.ItemID = productID;
        this.Product_Name = prod.ProductName;
        this.Product_Image = prod.getImage;
        this.Product_Price = prod.getProductPrice;
        this.Product_Type = prod.getProductType;
    ...
    public ShoppingCartItem(string productID, string productName, string productImg, decimal productPrice, string productType)
    {
        this.ItemID = productID;
